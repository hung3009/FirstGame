    ...
    def main():
        ...
        while not game_over:
            ...
            if meeting_acceleration == True:
                effect_acceleration += 1
                if effect_acceleration == 75:
...
class Minigame:
        def __init__(self):
            ...
            self.xScreen, self.yScreen = 960, 540  # Screen create
            linkBackGround = 'background.jpg'  # Đường dẫn ảnh background
            self.linkImgBird = "bird.png"  # Đường dẫn ảnh bird
            self.screen = pygame.display.set_mode(
                (self.xScreen, self.yScreen))  # Khởi tao kích thước màn hình
            pygame.display.set_caption("GAME PHỤ")
        ...
        def run(self):
            while self.gamerunning:
                ...
                self.show_score(self.xScreen - 200, 20, "NHÓM 7", 15)
