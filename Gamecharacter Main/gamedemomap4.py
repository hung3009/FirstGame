...
yrand =  [150, 305, 1000, 370, 1000 ,435, 1000 ,490, 1000, 1000]
...
class Playered1():
    def __init__(self):
        ...
        self.surface3 = pygame.image.load('17.2.png')
        self.speed = 0
...
class Playered2():
    def __init__(self):
        ...
        self.surface3 = pygame.image.load('18.png')
        self.speed = 0
        self.surfacelist = [self.surface1,self.surface2,self.surface3]
        self.surface = random.choice(self.surfacelist)
    def draw(self, bg):
...
class Playered5():
    def __init__(self):
        ...
        self.surface3 = pygame.image.load('20.png')
        self.speed = 0
        self.surfacelist = [self.surface1,self.surface2,self.surface3]
        self.surface = random.choice(self.surfacelist)
    def draw(self, bg):
